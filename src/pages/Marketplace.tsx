    ...
    <div className="w-full max-w-[1240px] mx-auto px-4 xl:px-0 py-4">
      <div className="text-white">
        ...
        <div className="text-center font-medium text-white">
            <a href="" className="text-amber-400 text-xl">To list your products on KFA Marketplace, please click here to fill out the form.</a>
            <p className="mt-8">KFA Marketplace makes the transactions easier for both buyers and sellers. KeebsForAll releases the funds to the sellers after we verify the condition and description of the product upon its arrival to the KFA warehouse. Sellers will sell their products faster and will have to do minimal work on their end. All seller fees are listed on the listing submission form. If the buyer receives the item not as described, they are required to contact us within 48 hours of receipt. Please keep in mind that items will take 2-3 weeks to ship, as we have to communicate with the sellers, wait to receive the items, process them, then ship them to you.  Due to the nature of these products, we do not offer returns or refunds for items. Starting January 1st, 2023, there will be no cancellations on Marketplace Products. For more information, please join our Discord server.
            </p>
